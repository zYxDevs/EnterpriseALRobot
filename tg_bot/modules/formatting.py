...
async def fmt_md_help(update: Update, context: CallbackContext):
...
async def fmt_filling_help(update: Update, context: CallbackContext):
    await update.effective_message.reply_text(
...
async def fmt_help(update: Update, context: CallbackContext):
